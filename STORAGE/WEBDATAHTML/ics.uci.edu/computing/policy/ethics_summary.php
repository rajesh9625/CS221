summary of ethical computing policy @ the bren school of information and computer sciences<html="http://www.w3.org/1999/xhtml">
<head>
                <title>summary of ethical computing policy @ the bren school of information and computer sciences</title>
                
                
                <meta content="Wed, 06 Nov 2013 11:52:55 -0320" name="date"/>
...
<div id="content_title">Summary of Ethical Computing Policy</div>

<blockquote>
<div id="content_text">

<p>This document is intended to remind you of the key points
            covered in the document <a href="ethics.php"> Ethical Use 
of Computing
            Resources</a> which you read in order to get an account. If 
you have
            any questions about the information in this document, you 
can reread
            the ethics document by visting <a href="ethics.php">
 Ethical Use of Computing Resources</a>,
you can send an email message to <a href="mailto:helpdesk@ics.uci.edu">helpdesk</a>,
or you can
visit CS 346.
          </p>
<hr/>
<p><b>Ethical Behavior</b><br/>
         The two most important points in the ethics document are 
that:
          </p>
<ul>
<li>The user must behave ethically at <i> all</i> times.</li>
<li>Each user is <i> solely</i> responsible for the actions of anyone using his/her account. Please see&#160;<a href="ethics.php">Ethical Use 
of Computing Resources</a>.</li>
</ul>
Unethical behavior includes, but is not limited to the 
following:
          
<ul>
<li>Introducing viruses, worms, trojan horses, password cracking, or login/e-mail spoofing programs to any University computer</li>
<li>Gaining unauthorized access to equipment or accounts</li>
<li>Wasting resources</li>
<li>Destroying electronic information belonging to others</li>
<li>Spying on others</li>
<li>Making commercial or political use of computing resources</li>
<li>Misuse of licensed software</li>
<li>Sending mass mailings of messages to random people</li>
<li>Sending chain letters through e-mail</li>
</ul>
