cycle servers and grid engine @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>cycle servers and grid engine @ the bren school of information and computer sciences</title>
                
                
                <meta content="Fri, 30 Oct 2015 13:30:30 -0380" name="date"/>
...
<div id="content_title">Cycle Servers and Grid Engine</div>

<blockquote>
<div id="content_text">

<p>Accessing your home directory from a Unix/Linux host is as simple as logging in. You may log in remotely from any host using a secure protocol such as <a href="http://en.wikipedia.org/wiki/Secure_Shell" target="_blank" title="Secure Shell Wikipedia Page">SSH2</a>. For Windows users, <a href="http://www.chiark.greenend.org.uk/%7esgtatham/putty/">PuTTY</a> is recommended and can be downloaded for free. For Mac users, you can use the terminal (found under Applications -&gt; Utilities).&#160;</p>
<ul>
<li>Students:&#160;openlab.ics.uci.edu (also known as archer.ics.uci.edu)</li>
<li>Faculty: emp.ics.uci.edu</li>
</ul>
<p>There is an instance of the <a href="http://en.wikipedia.org/wiki/Sun_Grid_Engine" target="_blank" title="Sun Grid Engine Wikipedia Page">Sun Grid Engine software</a>&#160;that is used to help faciliate running multiple jobs on the openlab. Please see our <a href="sge.php" title="Bren:ICS SGE Page">SGE</a>&#160;page for more information.&#160;</p>
<p>New to Linux or UNIX? See this excellent introduction by Princeton for <a href="https://cgi.math.princeton.edu/compudocwiki/index.php?title=Documentation_and_Information:Getting_started_with_Linux" title="Princeton Getting Started with Linux guide">getting started with Linux</a> command line.</p>
<p>To get more information on accessing and viewing available software on the servers, see our <a href="modules.php" title="Modules help page">Modules</a>&#160;page.</p>
<p><b>openlab.ics.uci.edu</b></p>
<ul>
<li>Quad 2.4GHz 16-core AMD Opteron 6378 CPUs</li>
<li>512GB RAM</li>
<li>64-bit CentOS Linux</li>
<li>1TB scratch space</li>
<li>1 machine</li>
</ul>
<ul>
<li>Dual 2.2GHz Single Core AMD Opteron 252 CPUs</li>
<li>16GB RAM</li>
<li>64-bit CentOS Linux</li>
<li>30GB scratch space</li>
<li>13 machines</li>
</ul>
<ul>
<li>Dual dual-core AMD Opteron 2212HE</li>
<li>16GB RAM</li>
<li>64-bit CentOS Linux</li>
<li>400GB scratch space</li>
<li>2 machines</li>
</ul>
<ul>
<li>Dual Intel Pentium 3.0GHz</li>
<li>4GB RAM</li>
<li>64-bit CentOS Linux</li>
<li>400GB scrach space</li>
<li>3 machines</li>
</ul>
<p><b>andromeda-#.ics.uci.edu where # is 1-40</b></p>
<ul>
<li>2x Quad-core&#160;Intel Xeon 3.0GHz CPU E5450&#160;CPUs</li>
<li>32GB RAM</li>
<li>64-bit CentOS Linux 6.6</li>
<li>500GB scratch space</li>
<li>40 machines</li>
</ul>
