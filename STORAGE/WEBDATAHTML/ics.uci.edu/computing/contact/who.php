who to contact @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>who to contact @ the bren school of information and computer sciences</title>
                
                
                <meta content="Mon, 04 Nov 2013 14:01:50 -0320" name="date"/>
...
<div id="content_title">Who to contact</div>
...
<p>
Please send mails to <a href="mailto:helpdesk@ics.uci.edu">helpdesk@ics.uci.edu</a> for questions/problems regarding:
</p>
<ul>
<li> Unix/Linux system and software
</li>
<li> Email, email forwarding
</li>
<li> Windows system and software
</li>
<li> Print queues and printer access</li>
<li>MSDNAA software</li>
<li>ICS account requests and issues</li>
<li>Quota information and requests</li>
<li> File restoration from H drive (please also refer to <a href="../services/snapshot.php">
How to restore file</a>)</li>
</ul>
<p>
Please send mails to <a href="mailto:webmaster@ics.uci.edu">webmaster@ics.uci.edu</a> for:
</p>
<ul>
<li> WWW questions/problems (please also refer to
<a href="../web/faqs.php">ICS Web Resources</a>)</li>
</ul>
<p>
Please send mails to <a href="mailto:lab@ics.uci.edu">lab@ics.uci.edu</a> for:
</p>
<ul>
<li> ICS instructional lab questions (please also refer to
<a href="http://www.ics.uci.edu/%7elab"> Lab Home Page</a>&#160;or visit the lab at CS 364)</li>
</ul>
<p>
Please send mails to <a href="mailto:oit@uci.edu">oit@uci.edu</a> for:
</p>
<ul>
<li> Wireless/remote access to the UCI network</li>
<li> General UNIX questions
</li>
<li>UCI account requests and issues</li>
</ul>
