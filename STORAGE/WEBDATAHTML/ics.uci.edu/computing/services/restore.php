file restore request @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>file restore request @ the bren school of information and computer sciences</title>
...
<div id="content_title">File Restore Request</div>

<blockquote>
<div id="content_text">

<p><b>Purpose:</b><br/>
Accidentally deleted files or files that are discovered to be important
 after
deletion can be recovered.
          </p>
<p> <b>Performed by:</b><br/>Vipada Deleon, Support Group          </p>
<p> <b> Procedure:</b> <br/>
  If your home directory is on the server named TRON, you can retrieve 
the data
    yourself from a&#160;<a href="snapshot.php">snapshot</a>.</p>
<p>Otherwise, send an email message to <a href="mailto:helpdesk@ics.uci.edu">
 helpdesk@ics.uci.edu </a> containing
          the
following information:
          </p>
<ol>
<li> Your ICS login name            </li>
<li> A full path from your ICS home directory to the missing
 files/directories.            </li>
<li> A complete list of what needs to be restored (if 
directories,
              there is no need to list directory contents).            </li>
<li> The last date the files existed on or were valid on.   
       </li>
</ol>
<p> <b>Lead time:</b><br/>
  Allow 2 working days for a file restore request.          </p>
