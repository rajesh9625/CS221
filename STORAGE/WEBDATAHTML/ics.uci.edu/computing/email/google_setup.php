ICS Google Account Setup @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>ICS Google Account Setup @ the bren school of information and computer sciences</title>
                
                
                <meta content="Fri, 28 Feb 2014 14:16:10 -0320" name="date"/>
...
<div id="content_title">ICS Google Account Setup</div>

<blockquote>
<div id="content_text">

<h3><span style="font-size: 1.17em;">Creation</span></h3>
<p>An ICS Google Apps account will be automatically created for all ICS faculty, staff, and graduate students. &#160;</p>
<p>If you are a new user then you need take no additional action. &#160;Your ICS Google Apps account was setup, and your forwarding address was set. &#160;You may login <a href="http://mail.google.com/a/ics.uci.edu" title="ICS Google Aps Login">here</a>&#160;and access your email.</p>
<p>Please continue on to Setup if you have an existing ICS account.</p>
<h3>Setup</h3>
<p>If you are an existing ICS user, then you will need to login to&#160;<a href="https://elnino.ics.uci.edu" title="https://elnino.ics.uci.edu">https://elnino.ics.uci.edu</a>&#160;and make two additional changes.&#160; <strong>Note: </strong>from off-campus locations, you must use the <a href="http://www.nacs.uci.edu/security/vpn/" target="_blank" title="UCI VPN">UCI VPN</a>&#160;client.</p>
<p>Change your password by clicking on the <strong>Change Password</strong>&#160;button.&#160;</p>
<p><span>Under forwarding address, select <strong>ICS Gmail</strong>. &#160; Leave the textbox empty as demonstrated below.</span></p>
<p><span><img alt="Elnino Password and Forwarding Address Setup" height="368" src="../bin/img/email/google/pw-and-icsgmail-select.png" width="367"/></span></p>
<p>&#160;</p>
<p><span><strong>Note</strong>: &#160;Faculty may be presented with the following information when logging into elnino.com. &#160;Click on the <strong>My Account</strong> button, as indicated below, in order to bring up the above page.</span></p>
<p>&#160;</p>
<p><span><img alt="ICS Faculty Elnino Presentation" height="176" src="../bin/img/email/google/facultyElninoPresentation.png" width="395"/><br/></span></p>
