Email Delivery Point  @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>Email Delivery Point  @ the bren school of information and computer sciences</title>
                
                
                <meta content="Wed, 16 Apr 2014 10:19:32 -0380" name="date"/>
...
<div id="content_title">Email Delivery Point Setup</div>

<blockquote>
<div id="content_text">

<h3><span style="font-size: 14px;">&#160;</span></h3>
<p>If you are an existing ICS Faculty, Staff, or Graduate Student, then you will need to login to&#160;<a href="https://elnino.ics.uci.edu" title="https://elnino.ics.uci.edu">https://elnino.ics.uci.edu</a>&#160;to specify your email delivery point.&#160; <strong>Note: </strong>from off-campus locations, you must use the <a href="http://www.nacs.uci.edu/security/vpn/" target="_blank" title="UCI VPN">UCI VPN</a>&#160;client.</p>
<p>&#160;</p>
<p><span>Under Forwarding Address, specify your delivery point.&#160; &#160;For ICS GMail and UCI, leave the textbox empty. &#160;<br/>For Other, you will need to specify <span id="docs-internal-guid-1fc8485d-6b81-e943-80db-989ea7c9cb33"><span> the email address where your ICS e-mail will be delivered in the textbox.</span></span></span></p>
<p><span><img alt="Elnino Password and Forwarding Address Setup" height="397" src="../bin/img/email/delivery.PNG" width="757"/></span></p>
<p>&#160;</p>
