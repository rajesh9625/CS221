vacation message @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>vacation message @ the bren school of information and computer sciences</title>
                
                
                <meta content="Mon, 26 Jan 2015 14:23:25 -0320" name="date"/>
...
<div id="content_title">vacation message</div>

<blockquote>
<div id="content_text">

<p>If you have multiple Google accounts, please make sure that you log off any non-ICS Google accounts and then follow the steps below.</p>
<ol>
<li>Open a browser and go to <strong>www.gmail.com</strong>. &#160;Use <strong>username@ics.uci.edu </strong>as your username and your<strong> ICS password</strong> to login.</li>
<li>On the upper right corner, click on the gear symbol.</li>
<li>Select <strong>Settings</strong>.</li>
<li>Under <strong>General</strong>, scroll down to <strong>Vacation responder.</strong></li>
<li>Turn it on, set the date range, subject, and type in your vacation message.&#160;</li>
<li>Then scroll down and click on <strong>Save Changes</strong>.<br/>
<br/><img alt="group email" height="311" src="../bin/img/email/vacation" width="710"/></li>
</ol>
