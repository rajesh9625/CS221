password change/reset @ the bren school of information and computer sciences<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                <title>password change/reset @ the bren school of information and computer sciences</title>
                
                
                <meta content="Wed, 23 Sep 2015 14:34:42 -0380" name="date"/>
...
<div id="content_title">Password Change/Reset</div>

<blockquote>
<div id="content_text">

<p><a href="https://support.ics.uci.edu/passwd/" title="ICS Password">Resetting Password</a></p>
<p>If you know your current password and would like to change it, please follow the link above. Use your current password to authenticate.</p>
<p><b>Changing Password</b></p>
<p>If you have forgotten your password and need it reset, please do one of the following:</p>
<ul>
<li>Student (Undergrad and Grad): Please bring your student ID to CS 364 lab and ask the lab attendant for further assistance.
<ul>
<li>If you cannot make it to campus but need to change your password, please contact <a href="mailto:helpdesk@ics.uci.edu">helpdesk</a>.</li>
</ul>
</li>
<li>Staff/Faculty: Please contact Helpdesk via email (<a href="mailto:helpdesk@ics.uci.edu">helpdesk@ics.uci.edu</a>) or telephone (949-824-4222).</li>
</ul>
<p>Furthermore, you may reset your password at <a href="https://support.ics.uci.edu/ltb" target="_blank">https://support.ics.uci.edu/ltb</a>&#160;if you:</p>
<ul>
<li>know your current password, or</li>
<li>have set and can answer your security question, or</li>
<li>have access to your alternate email address, which will be used to send a password reset message to</li>
</ul>
